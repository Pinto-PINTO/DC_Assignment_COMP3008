...
namespace SimpleWebAPI.Controllers
{
    ...
    public class RegistryController : ApiController
    {
        ...
        public RegistryOBJ Search(int authToken,string searchText)
        {
            ...
            {
                using (StreamReader r = new StreamReader(@"C:\Users\ASUS\Desktop\ServiceRegistry.txt"))
                {
                    string json = r.ReadToEnd();
                    List<RegistryOBJ> items = JsonConvert.DeserializeObject<List<RegistryOBJ>>(json);

                    //   RegistryOBJ item = JsonConvert.DeserializeObject<RegistryOBJ>(json);
       ...
       /*
        ...
        [Route("GetAllServices")]
        [HttpGet]
        public List<RegistryOBJ> PreAuthGetAllServices()
        {
        ...
        */
        ...
        public RegistryOBJ Post([FromUri()] int authToken,[FromBody] RegistryOBJ obj)
        {
            ...
            if (validator.Validate(authToken))
            {
                ...
                //  System.IO.File.AppendAllText(@"C:\Users\ASUS\Desktop\ServiceRegistry.txt", json);



                using (StreamWriter file = File.CreateText(@"C:\Users\ASUS\Desktop\ServiceRegistry.txt"))
                {
